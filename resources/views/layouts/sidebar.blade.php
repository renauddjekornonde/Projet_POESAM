        ...
        <ul class="nav flex-column py-3">
            ...
            <li class="nav-item">
                <a class="nav-link text-white py-3 px-4 {{ request()->is('organisation/cases*') ? 'active' : '' }}"
                   href="{{ route('organisation.cases.index') }}"
            ...
            <li class="nav-item">
                <a class="nav-link text-white py-3 px-4 {{ request()->is('organisation/cases/statistics') ? 'active' : '' }}"
                   href="{{ route('organisation.cases.statistics') }}"
                   style="{{ request()->is('organisation/cases/statistics') ? 'background-color: #8e44ad;' : '' }}">
                    <i class="fas fa-chart-bar me-2"></i>
                    Statistiques
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link text-white py-3 px-4 {{ request()->is('organisation/profile*') ? 'active' : '' }}"
                   href="{{ route('organisation.profile.show') }}"
                   style="{{ request()->is('organisation/profile*') ? 'background-color: #8e44ad;' : '' }}">
